...
An interactive Python tool for downloading complete chat histories from Keybase, with automatic image optimization.
...
- **Attachment handling** - Downloads all attachments (images, files, etc.)
- **WebP optimization** - Automatically converts images to optimized WebP format for web use
- **Multiple export formats**:
  - `messages_raw.json` - Full API response data
  - `messages_formatted.json` - Cleaned/structured message data with WebP filenames
